          ...
          <div class="col-lg-6">
            <div class="p-5">
              <div class="text-center">
                 <img width="auto" height="70" src="<?php echo base_url(); ?>img/rizal.png"><br><br>
                 <h6><b>KTU Clinic</b></h6>
                <h1 class="h4 text-gray-900 mb-4">Koforidua Technical University School</h1>
              </div>
              <hr>
