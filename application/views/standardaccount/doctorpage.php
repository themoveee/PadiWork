...
<body id="page-top">
 ...
 <?php echo "<div class='alert-success text-center'>".$this->session->flashdata('sec_pass')."</div>"  ?>
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class=" navbar-nav bg-info bg-gradient sidenav sidebar sidebar-dark accordion " id="accordionSidebar">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Koforidua Technical University School 2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
